...
class LineItemManager extends Manager
{
	...
	{
		$this->lineItemName = 'SmartGam_'.$this->bucket;
	...
	public function createLineItem()
	{
		...
		do {
			try {
				$results = $lineItemService->createLineItems([$this->setUpSmartGamLineItem()
	...
	public function updateLineItem($lineItem)
	{
		...
		do {
			try {
				$results = $lineItemService->updateLineItems([$this->setUpSmartGamLineItem()
	...
	private function setUpSmartGamLineItem()
	{
